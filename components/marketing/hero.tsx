...
const Hero = () => {
    return (
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative">
            ...
            <BlurText
                word={"Turn Your Videos Into\n Captivating Viral Blog Posts"}
            ...
            <Container delay={0.1}>
                <p className="text-sm sm:text-base lg:text-lg mt-4 text-accent-foreground/60 max-w-2xl mx-auto">
                    Effortlessly convert videos into engaging, SEO Friendly blog posts. content creation with AI. <span className="hidden sm:inline">Vidscribe is the all-in-one solution for your content creation needs.</span>
                </p>
            </Container>
            <Container delay={0.2}>
